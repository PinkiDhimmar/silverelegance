...
INSERT INTO `orders` (`id`, `user_id`, `total_amount`, `status`, `created_at`, `tracking_number`, `address`, `city`, `postal_code`, `payment_method`, `updated_at`, `shipping_address`, `customer_name`, `email`, `payment_id`, `payment_details`, `shipping_method`, `courier_fee`, `courier_name`, `tracking_link`) VALUES
...
CREATE TABLE `products` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `is_special_active` tinyint(1) NOT NULL,
  `special_event_name` varchar(255) NOT NULL,
  `special_ends_on` datetime NOT NULL,
...
(8, 'Pear Blue/White Halo Party Ring', '       RING SIZE 56\r\nThis beautiful 925 sterling silver cocktail ring is a great addition to any wedding or party ensemble. crafted from highest quality materials, you can wear this ring with confidence.', 55.00, 1, 'bluewhite party ring (1).jpg', 1, '2025-07-16 09:25:52', 0, '', '0000-00-00 00:00:00', 0),
(9, 'Halo Pear Gemstone Blue Sapphire Ring', '            RING SIZE 52\r\nThis ring capture the essence of timeless beauty and can be custom-made to reflect your unique love story.', 60.00, 1, 'bluewhite party ring (3).jpg', 1, '2025-07-16 09:27:44', 0, '', '0000-00-00 00:00:00', 0),
(10, 'Kada Bracelet', '            Silver-toned kada bracelet\r\nMaterial and stone type: sterling silver with american diamond\r\nClosure: slip-on\r\n\r\nSize & Fit\r\nCircumference(in Cm):7.6\r\n\r\nMaterial & Care\r\nMaterial: Sterling Silver\r\nStone type: American Diamond', 40.00, 1, 'diamond bracelet.jpg', 3, '2025-07-16 09:32:11', 0, '', '0000-00-00 00:00:00', 0),
(11, '2 Star Charm Bracelet', ' This Bracelet is designed to fit comfortably on your wrist, featuring an adjustable design that allows you to customize the fit for a snug and secure feel.   Whether you\'re dressing up for a special occasion or adding a unique touch to your everyday attire, this kada is versatile and suitable for various outfits and styles.', 35.00, 1, 'star bracelet.jpg', 3, '2025-07-16 09:34:09', 0, '', '0000-00-00 00:00:00', 0),
(12, 'Dolphines Ankeletes with Snake Chain', '            One Size - 2 Piece\r\nIt is charm jewelry, so it\'s no surprise that the anklets has been adorned with small, meaningful charms. The anklets with dangling dolphine charms.', 100.00, 1, 'dolphine ankelet.jpg', 5, '2025-07-16 09:39:03', 0, '', '0000-00-00 00:00:00', 0),
(13, 'Round Sparkle Halo Ring', '            Ring Size 56\r\nFinely crafted in sterling silver, this vintage-inspired piece features a large brilliant-cut cubic zirconia stone surrounded by tiny shimmering stones. This sparkling Pandora ring will add sophistication to every outfit, from simple, everyday ensembles to glamorous evening wear.', 25.00, 0, 'ring1.jpg', 1, '2025-07-16 23:26:41', 0, '', '0000-00-00 00:00:00', 0);
...
(20, 'Pinki Dhimmar', 'pinkidhimmar@gmail.com', '$2b$12$qWD26qtVyFD88GZpPyy3N.E7yWYBMPNhDbp0t6yRcoNU4y.jdVwWS', 'customer', '0211160825', '1989-11-24', '32 Queens Drive Lower Hutt', 'Wellington', '5001', 'New Zealand', '2025-07-22 07:03:12', '2025-07-22 19:03:12', '', '0000-00-00 00:00:00');
