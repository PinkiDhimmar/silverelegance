...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2025 at 02:59 AM
...
INSERT INTO `orders` (`id`, `user_id`, `total_amount`, `status`, `created_at`, `tracking_number`, `address`, `city`, `postal_code`, `payment_method`, `updated_at`, `shipping_address`, `customer_name`, `email`, `payment_id`, `payment_details`, `shipping_method`, `courier_fee`) VALUES
